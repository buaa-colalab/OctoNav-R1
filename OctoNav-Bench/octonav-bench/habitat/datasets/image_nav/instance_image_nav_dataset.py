...
from habitat.datasets.pointnav.pointnav_dataset import (
    DEFAULT_SCENE_PATH_PREFIX, PointNavDatasetV1)
from habitat.tasks.nav.instance_image_nav_task import (
    InstanceImageGoal, InstanceImageGoalNavEpisode, InstanceImageParameters)
...
class InstanceImageNavDatasetV1(PointNavDatasetV1):
    ...
    @staticmethod
    def _deserialize_goal(serialized_goal: Dict[str, Any]):
        ...
        for vidx, view in enumerate(g.view_points):
            ...
            view_location.agent_state = AgentState(
                **view_location.agent_state)  # type: ignore[arg-type]
