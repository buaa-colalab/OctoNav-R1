...
class RLTaskEnv(habitat.RLEnv):
    ...
    def __init__(self,
        ...
        for task_name, task_config in config.tasks.items():
            self._reward_measure_name[task_name] = task_config.reward_measure
            self._success_measure_name[task_name] = task_config.success_measure
    ...
    def get_reward(self, observations):
        current_measure = self._env.get_metrics()[self.reward_measure_name]
    ...
    def _episode_success(self):
        return self._env.get_metrics()[self.success_measure_name]
