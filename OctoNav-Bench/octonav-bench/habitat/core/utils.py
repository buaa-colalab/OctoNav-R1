...
def tile_images(images: List[np.ndarray]) -> np.ndarray:
    ...
    # img_HWhwc
    out_image = np_images.reshape(new_height, new_width, height, width,
                                  n_channels)
    # img_HhWwc
...
def not_none_validator(self: Any, attribute: attr.Attribute,
...
class DatasetJSONEncoder(json.JSONEncoder):
    ...
    def default(self, obj: Any) -> Any:
        ...
        return (obj.__getstate__()
                if hasattr(obj, "__getstate__") else obj.__dict__)
